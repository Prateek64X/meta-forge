...
const ProfilePage: React.FC<{ userId: string; address: string; onLogout: () => void }> = ({
  userId,
  address,
  onLogout,
}) => {
      ...
      <Container maxWidth="md" sx={{ pt: 4, pb: 8 }}>
        ...
        >
          ...
          <Card sx={{ 
            ...
            border: `1px solid ${theme.palette.secondary.main}33`, // 33 = 20% opacity
            borderRadius: '16px',
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    sx={{
                      '& .MuiInputLabel-root': {
                        color: `${theme.palette.secondary.main}aa` // aa = 66% opacity
                      },
